...
int init_wc_Class(HINSTANCE hInstance){
	...
	Mainwin.lpszClassName = "Mainwin";
	Mainwin.hIcon		 = (HICON)LoadImage(NULL, ".\\res\\ico\\netmusic_logoS.ico", IMAGE_ICON, 0, 0, LR_LOADFROMFILE);
	Mainwin.hIconSm		 = (HICON)LoadImage(NULL, ".\\res\\ico\\netmusic_logoS.ico", IMAGE_ICON, 0, 0, LR_LOADFROMFILE);
	cheackClass(Mainwin);
	...
	MainIndex_Btn.lpszClassName = "MainIndex_Btn";
	...
	myMusicItem_Btn.lpszClassName = "myMusicItem_Btn";
	...
	LMENU_scroll.lpszClassName = "LMENU_scroll";
	...
	Edit_out_class.lpszClassName = "Edit_out_class";
	...
	myOP_Btn_Class.lpszClassName = "myOP_Btn_Class";
	...
	WhiteBackgroundClass.lpszClassName = "WhiteBackgroundClass";
